  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `todo_items` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `title` TEXT NOT NULL, `description` TEXT NOT NULL, `isCompleted` INTEGER NOT NULL, `createdAt` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'd426c047983a30f5206b21b346277141')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsTodoItems = new HashMap<String, TableInfo.Column>(5);
        ...
        _columnsTodoItems.put("description", new TableInfo.Column("description", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoTodoItems.equals(_existingTodoItems)) {
          return new RoomOpenHelper.ValidationResult(false, "todo_items(com.example.mylist.data.TodoItem).\n"
                  + " Expected:\n" + _infoTodoItems + "\n"
                  + " Found:\n" + _existingTodoItems);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "d426c047983a30f5206b21b346277141", "8fc586b824126424706d980d2132d66a");
